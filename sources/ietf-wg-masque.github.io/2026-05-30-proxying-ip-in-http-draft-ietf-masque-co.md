---
url: https://ietf-wg-masque.github.io/draft-ietf-masque-connect-ip/fix180/draft-ietf-masque-connect-ip.html
title: Proxying IP in HTTP
fetched_at: 2026-05-30T17:09:30
content_hash: sha1:7fefcfea0ef3feda0ed39ac791e86bf8f65ab478
extractor: trafilatura
---

| RFC 9484 | Proxying IP in HTTP | September 2023 |
...
document updates RFC 9298.[¶](https://ietf-wg-masque.github.io#section-abstract-1)

This is an Internet Standards Track document.[¶](https://ietf-wg-masque.github.io#section-boilerplate.1-1)
...
RFC 7841.[¶](https://ietf-wg-masque.github.io#section-boilerplate.1-2)

Information about the current status of this document, any
errata, and how to provide feedback on it may be obtained at
[https://www.rfc-editor.org/info/rfc9484](https://www.rfc-editor.org/info/rfc9484).[¶](https://ietf-wg-masque.github.io#section-boilerplate.1-3)

Copyright (c) 2023 IETF Trust and the persons identified as the
document authors. All rights reserved.[¶](https://ietf-wg-masque.github.io#section-boilerplate.2-1)
...
warranty as described in the Revised BSD License.[¶](https://ietf-wg-masque.github.io#section-boilerplate.2-2)

HTTP provides the CONNECT method (see [Section 9.3.6](https://rfc-editor.org/rfc/rfc9110#section-9.3.6) of [[HTTP](https://ietf-wg-masque.github.io#HTTP)]) for
creating a TCP [[TCP](https://ietf-wg-masque.github.io#TCP)] tunnel to a destination and a similar mechanism
for UDP [[CONNECT-UDP](https://ietf-wg-masque.github.io#CONNECT-UDP)]. However, these mechanisms cannot tunnel other
IP protocols [[IANA-PN](https://ietf-wg-masque.github.io#IANA-PN)] nor convey fields of the IP header.[¶](https://ietf-wg-masque.github.io#section-1-1)
...
communication, or general-purpose packet tunnelling.[¶](https://ietf-wg-masque.github.io#section-1-2)

IP proxying operates similarly to UDP proxying [[CONNECT-UDP](https://ietf-wg-masque.github.io#CONNECT-UDP)],
...
Template [[TEMPLATE](https://ietf-wg-masque.github.io#TEMPLATE)], as described in [Section 3](https://ietf-wg-masque.github.io#client-config).[¶](https://ietf-wg-masque.github.io#section-1-3)

This protocol supports all existing versions of HTTP by using HTTP Datagrams
[[HTTP-DGRAM](https://ietf-wg-masque.github.io#HTTP-DGRAM)]. When using HTTP/2 [[HTTP/2](https://ietf-wg-masque.github.io#H2)] or HTTP/3 [[HTTP/3](https://ietf-wg-masque.github.io#H3)], it uses
HTTP Extended CONNECT, as described in [[EXT-CONNECT2](https://ietf-wg-masque.github.io#EXT-CONNECT2)] and
[[EXT-CONNECT3](https://ietf-wg-masque.github.io#EXT-CONNECT3)]. When using HTTP/1.x [[HTTP/1.1](https://ietf-wg-masque.github.io#H1)], it uses HTTP Upgrade, as
defined in [Section 7.8](https://rfc-editor.org/rfc/rfc9110#section-7.8) of [[HTTP](https://ietf-wg-masque.github.io#HTTP)].[¶](https://ietf-wg-masque.github.io#section-1-4)

This document updates [[CONNECT-UDP](https://ietf-wg-masque.github.io#CONNECT-UDP)] to change the "masque" well-known URI;
see [Section 12.3](https://ietf-wg-masque.github.io#iana-uri).[¶](https://ietf-wg-masque.github.io#section-1-5)

The key words "MUST", "MUST NOT", "REQUIRED", "SHALL", "SHALL NOT", "SHOULD", "SHOULD NOT", "RECOMMENDED", "NOT RECOMMENDED",
"MAY", and "OPTIONAL" in this document are to be interpreted as
described in BCP 14 [[RFC2119](https://ietf-wg-masque.github.io#RFC2119)] [[RFC8174](https://ietf-wg-masque.github.io#RFC8174)] when, and only when, they
appear in all capitals, as shown here.[¶](https://ietf-wg-masque.github.io#section-2-1)
...
intermediaries (as defined in [Section 3.7](https://rfc-editor.org/rfc/rfc9110#section-3.7) of [[HTTP](https://ietf-wg-masque.github.io#HTTP)]) between the client and
the IP proxy, those are referred to as "intermediaries" in this document. The
term "IP proxying endpoints" refers to both the client and the IP proxy.[¶](https://ietf-wg-masque.github.io#section-2-2)

This document uses terminology from [[QUIC](https://ietf-wg-masque.github.io#QUIC)]. Where this document
defines protocol types, the definition format uses the notation from [Section 1.3](https://rfc-editor.org/rfc/rfc9000#section-1.3) of [[QUIC](https://ietf-wg-masque.github.io#QUIC)]. This specification uses the variable-length integer encoding
from [Section 16](https://rfc-editor.org/rfc/rfc9000#section-16) of [[QUIC](https://ietf-wg-masque.github.io#QUIC)]. Variable-length integer values do not
need to be encoded in the minimum number of bytes necessary.[¶](https://ietf-wg-masque.github.io#section-2-3)
...
entire connection.[¶](https://ietf-wg-masque.github.io#section-2-4)

Clients are configured to use IP proxying over HTTP via a URI Template
[[TEMPLATE](https://ietf-wg-masque.github.io#TEMPLATE)]. The URI Template MAY contain two variables: "target" and
"ipproto"; see [Section 4.6](https://ietf-wg-masque.github.io#scope). The optionality of the variables needs to be
considered when defining the template so that the variable is either
self-identifying or possible to exclude in the syntax.[¶](https://ietf-wg-masque.github.io#section-3-1)

Examples are shown below:[¶](https://ietf-wg-masque.github.io#section-3-2)

The following requirements apply to the URI Template:[¶](https://ietf-wg-masque.github.io#section-3-4)

- The URI Template MUST be a level 3 template or lower.
[¶](https://ietf-wg-masque.github.io#section-3-5.1) - The URI Template MUST be in absolute form and MUST include non-empty scheme,
authority, and path components.
[¶](https://ietf-wg-masque.github.io#section-3-5.2) - The path component of the URI Template MUST start with a slash "/".
[¶](https://ietf-wg-masque.github.io#section-3-5.3) - All template variables MUST be within the path or query components of the URI.
[¶](https://ietf-wg-masque.github.io#section-3-5.4) - The URI Template MAY contain the two variables "target" and "ipproto" and MAY
...
wildcard or no-preference values; see
[Section 4.6](https://ietf-wg-masque.github.io#scope).[¶](https://ietf-wg-masque.github.io#section-3-5.5) - The URI Template MUST NOT contain any non-ASCII Unicode characters and MUST
only contain ASCII characters in the range 0x21-0x7E inclusive (note that
percent-encoding is allowed; see
[Section 2.1](https://rfc-editor.org/rfc/rfc3986#section-2.1)of [[URI](https://ietf-wg-masque.github.io#URI)]).[¶](https://ietf-wg-masque.github.io#section-3-5.6) - The URI Template MUST NOT use Reserved Expansion ("+" operator), Fragment
...
Semicolon-Prefix.
[¶](https://ietf-wg-masque.github.io#section-3-5.7)
...
request without sending it to the IP proxy.[¶](https://ietf-wg-masque.github.io#section-3-6)
...
if they need to interoperate with such clients.[¶](https://ietf-wg-masque.github.io#section-3-7)
...
Protocol (see [Section 3.2](https://rfc-editor.org/rfc/rfc9297#section-3.2) of [[HTTP-DGRAM](https://ietf-wg-masque.github.io#HTTP-DGRAM)]) with HTTP Datagrams in the format
defined in [Section 6](https://ietf-wg-masque.github.io#payload-format).[¶](https://ietf-wg-masque.github.io#section-4-1)

To initiate an IP tunnel associated with a single HTTP stream, a client issues
a request containing the "connect-ip" upgrade token.[¶](https://ietf-wg-masque.github.io#section-4-2)

When sending its IP proxying request, the client SHALL perform URI Template
expansion to determine the path and query of its request; see [Section 3](https://ietf-wg-masque.github.io#client-config).[¶](https://ietf-wg-masque.github.io#section-4-3)

By virtue of the definition of the Capsule Protocol (see [Section 3.2](https://rfc-editor.org/rfc/rfc9297#section-3.2) of [[HTTP-DGRAM](https://ietf-wg-masque.github.io#HTTP-DGRAM)]), IP proxying requests do not carry any message content.
Similarly, successful IP proxying responses also do not carry any message
content.[¶](https://ietf-wg-masque.github.io#section-4-4)
...
authentication.[¶](https://ietf-wg-masque.github.io#section-4-5)

Upon receiving an IP proxying request:[¶](https://ietf-wg-masque.github.io#section-4.1-1)
...
[¶](https://ietf-wg-masque.github.io#section-4.1-2.1) - Otherwise, the recipient will act as an IP proxy. The IP proxy can choose to
...
[¶](https://ietf-wg-masque.github.io#section-4.1-2.2)

IP proxies MUST validate whether the decoded "target" and "ipproto" variables
meet the requirements in [Section 4.6](https://ietf-wg-masque.github.io#scope). If they do not, the IP proxy MUST treat the
request as malformed; see [Section 8.1.1](https://rfc-editor.org/rfc/rfc9113#section-8.1.1) of [[HTTP/2](https://ietf-wg-masque.github.io#H2)] and [Section 4.1.2](https://rfc-editor.org/rfc/rfc9114#section-4.1.2) of [[HTTP/3](https://ietf-wg-masque.github.io#H3)].
...
appropriate Proxy-Status header field [[PROXY-STATUS](https://ietf-wg-masque.github.io#PROXY-STATUS)]. For example,
if DNS resolution returns an error, the proxy can use the `dns_error`

proxy
error type from [Section 2.3.2](https://rfc-editor.org/rfc/rfc9209#section-2.3.2) of [[PROXY-STATUS](https://ietf-wg-masque.github.io#PROXY-STATUS)].[¶](https://ietf-wg-masque.github.io#section-4.1-3)
...
they MUST close the request stream when doing so.[¶](https://ietf-wg-masque.github.io#section-4.1-4)

A successful response (as defined in Sections [4.3](https://ietf-wg-masque.github.io#resp1) and [4.5](https://ietf-wg-masque.github.io#resp23))
...
the request has failed; thus, the client MUST abort the request.[¶](https://ietf-wg-masque.github.io#section-4.1-5)

Along with a successful response, the IP proxy can send capsules to assign
addresses and advertise routes to the client ([Section 4.7](https://ietf-wg-masque.github.io#capsules)). The client can
also assign addresses and advertise routes to the IP proxy for
network-to-network routing.[¶](https://ietf-wg-masque.github.io#section-4.1-6)

When using HTTP/1.1 [[HTTP/1.1](https://ietf-wg-masque.github.io#H1)], an IP proxying request will meet the following
requirements:[¶](https://ietf-wg-masque.github.io#section-4.2-1)

- The method SHALL be "GET".
[¶](https://ietf-wg-masque.github.io#section-4.2-2.1) - The request SHALL include a single Host header field containing the host
and optional port of the IP proxy.
[¶](https://ietf-wg-masque.github.io#section-4.2-2.2) - The request SHALL include a Connection header field with value "Upgrade"
(note that this requirement is case-insensitive, as per
[Section 7.6.1](https://rfc-editor.org/rfc/rfc9110#section-7.6.1)of [[HTTP](https://ietf-wg-masque.github.io#HTTP)]).[¶](https://ietf-wg-masque.github.io#section-4.2-2.3) - The request SHALL include an Upgrade header field with value "connect-ip".
[¶](https://ietf-wg-masque.github.io#section-4.2-2.4)
...
and SHOULD use the 400 (Bad Request) status code.[¶](https://ietf-wg-masque.github.io#section-4.2-3)
...
send the following request:[¶](https://ietf-wg-masque.github.io#section-4.2-4)

The server indicates a successful response by replying with the following
requirements:[¶](https://ietf-wg-masque.github.io#section-4.3-1)

- The HTTP status code on the response SHALL be 101 (Switching Protocols).
[¶](https://ietf-wg-masque.github.io#section-4.3-2.1) - The response SHALL include a Connection header field with value "Upgrade"
(note that this requirement is case-insensitive, as per
[Section 7.6.1](https://rfc-editor.org/rfc/rfc9110#section-7.6.1)of [[HTTP](https://ietf-wg-masque.github.io#HTTP)]).[¶](https://ietf-wg-masque.github.io#section-4.3-2.2) - The response SHALL include a single Upgrade header field with value
"connect-ip".
[¶](https://ietf-wg-masque.github.io#section-4.3-2.3) - The response SHALL meet the requirements of HTTP responses that start the
Capsule Protocol; see
[Section 3.2](https://rfc-editor.org/rfc/rfc9297#section-3.2)of [[HTTP-DGRAM](https://ietf-wg-masque.github.io#HTTP-DGRAM)].[¶](https://ietf-wg-masque.github.io#section-4.3-2.4)

If any of these requirements are not met, the client MUST treat this proxying
attempt as failed and close the connection.[¶](https://ietf-wg-masque.github.io#section-4.3-3)

For example, the server could respond with:[¶](https://ietf-wg-masque.github.io#section-4.3-4)

When using HTTP/2 [[HTTP/2](https://ietf-wg-masque.github.io#H2)] or HTTP/3 [[HTTP/3](https://ietf-wg-masque.github.io#H3)], IP proxying requests use HTTP
Extended CONNECT. This requires that servers send an HTTP Setting, as specified
in [[EXT-CONNECT2](https://ietf-wg-masque.github.io#EXT-CONNECT2)] and [[EXT-CONNECT3](https://ietf-wg-masque.github.io#EXT-CONNECT3)], and that requests use HTTP
pseudo-header fields with the following requirements:[¶](https://ietf-wg-masque.github.io#section-4.4-1)

- The :method pseudo-header field SHALL be "CONNECT".
[¶](https://ietf-wg-masque.github.io#section-4.4-2.1) - The :protocol pseudo-header field SHALL be "connect-ip".
[¶](https://ietf-wg-masque.github.io#section-4.4-2.2) - The :authority pseudo-header field SHALL contain the authority of the IP
proxy.
[¶](https://ietf-wg-masque.github.io#section-4.4-2.3) - The :path and :scheme pseudo-header fields SHALL NOT be empty. Their values
SHALL contain the scheme and path from the URI Template after the URI
Template expansion process has been completed; see
[Section 3](https://ietf-wg-masque.github.io#client-config). Variables in the URI Template can determine the scope of the request, such as requesting full-tunnel IP packet forwarding, or a specific proxied flow; see[Section 4.6](https://ietf-wg-masque.github.io#scope).[¶](https://ietf-wg-masque.github.io#section-4.4-2.4)

An IP proxying request that does not conform to these restrictions is
malformed; see [Section 8.1.1](https://rfc-editor.org/rfc/rfc9113#section-8.1.1) of [[HTTP/2](https://ietf-wg-masque.github.io#H2)] and [Section 4.1.2](https://rfc-editor.org/rfc/rfc9114#section-4.1.2) of [[HTTP/3](https://ietf-wg-masque.github.io#H3)].[¶](https://ietf-wg-masque.github.io#section-4.4-3)

For example, if the client is configured with URI Template
"https://example.org/.well-known/masque/ip/{target}/{ipproto}/" and wishes to
open an IP forwarding tunnel with no target or protocol limitations, it could
send the following request:[¶](https://ietf-wg-masque.github.io#section-4.4-4)

The server indicates a successful response by replying with the following
requirements:[¶](https://ietf-wg-masque.github.io#section-4.5-1)

- The HTTP status code on the response SHALL be in the 2xx (Successful) range.
[¶](https://ietf-wg-masque.github.io#section-4.5-2.1) - The response SHALL meet the requirements of HTTP responses that start the
Capsule Protocol; see
[Section 3.2](https://rfc-editor.org/rfc/rfc9297#section-3.2)of [[HTTP-DGRAM](https://ietf-wg-masque.github.io#HTTP-DGRAM)].[¶](https://ietf-wg-masque.github.io#section-4.5-2.2)
...
request.[¶](https://ietf-wg-masque.github.io#section-4.5-3)

For example, the server could respond with:[¶](https://ietf-wg-masque.github.io#section-4.5-4)
...
to different prefixes and/or different protocols.[¶](https://ietf-wg-masque.github.io#section-4.6-1)

The scope of the request is indicated by the client to the IP proxy via the
"target" and "ipproto" variables of the URI Template; see [Section 3](https://ietf-wg-masque.github.io#client-config).
Both the "target" and "ipproto" variables are optional; if they are not
included, they are considered to carry the wildcard value "*".[¶](https://ietf-wg-masque.github.io#section-4.6-2)

- target:
-
The variable "target" contains a hostname or IP prefix of a specific host to which the client wants to proxy packets. If the "target" variable is not specified or its value is "*", the client is requesting to communicate with any allowable host. "target" supports using DNS names, IPv6 prefixes, and IPv4 prefixes. Note that IPv6 scoped addressing zone identifiers [

[IPv6-ZONE-ID](https://ietf-wg-masque.github.io#IPv6-ZONE-ID)] are not supported. If the target is an IP prefix (IP address optionally followed by a percent-encoded slash followed by the prefix length in bits), the request will only support a single IP version. If the target is a hostname, the IP proxy is expected to perform DNS resolution to determine which route(s) to advertise to the client. The IP proxy SHOULD send a ROUTE_ADVERTISEMENT capsule that includes routes for all addresses that were resolved for the requested hostname, that are accessible to the IP proxy, and belong to an address family for which the IP proxy also sends an Assigned Address.[¶](https://ietf-wg-masque.github.io#section-4.6-3.2.1) - ipproto:
-
The variable "ipproto" contains an Internet Protocol Number; see the defined list in the "Assigned Internet Protocol Numbers" IANA registry [

[IANA-PN](https://ietf-wg-masque.github.io#IANA-PN)]. If present, it specifies that a client only wants to proxy a specific IP protocol for this request. If the value is "*", or the variable is not included, the client is requesting to use any IP protocol. The IP protocol indicated in the "ipproto" variable represents an allowable next header value carried in IP headers that are directly sent in HTTP Datagrams (the outermost IP headers). ICMP traffic is always allowed, regardless of the value of this field.[¶](https://ietf-wg-masque.github.io#section-4.6-3.4.1)

Using the terms IPv6address, IPv4address, and reg-name from [[URI](https://ietf-wg-masque.github.io#URI)], the
"target" and "ipproto" variables MUST adhere to the format in
[Figure 6](https://ietf-wg-masque.github.io#target-format), using notation from [[ABNF](https://ietf-wg-masque.github.io#ABNF)]. Additionally:[¶](https://ietf-wg-masque.github.io#section-4.6-4)
...
[¶](https://ietf-wg-masque.github.io#section-4.6-5.1) - If present, the IP prefix length in "target" SHALL be preceded by a
...
[¶](https://ietf-wg-masque.github.io#section-4.6-5.2) - If "target" contains an IP prefix and the prefix length is strictly less than
...
[¶](https://ietf-wg-masque.github.io#section-4.6-5.3) - "ipproto" MUST represent a decimal integer between 0 and 255 inclusive or
the wildcard value "*".
[¶](https://ietf-wg-masque.github.io#section-4.6-5.4)
...
included in the scope, then the IP proxy can immediately reject the request.[¶](https://ietf-wg-masque.github.io#section-4.6-7)
...
these new capsules.[¶](https://ietf-wg-masque.github.io#section-4.7-1)
...
as the source address on IP packets originated by the receiver of this capsule.[¶](https://ietf-wg-masque.github.io#section-4.7.1-1)

The ADDRESS_ASSIGN capsule contains a sequence of zero or more Assigned
Addresses.[¶](https://ietf-wg-masque.github.io#section-4.7.1-3)

Each Assigned Address contains the following fields:[¶](https://ietf-wg-masque.github.io#section-4.7.1-5)

- Request ID:
-
Request identifier, encoded as a variable-length integer. If this address assignment is in response to an Address Request (see

[Section 4.7.2](https://ietf-wg-masque.github.io#addr_req)), then this field SHALL contain the value of the corresponding field in the request. Otherwise, this field SHALL be zero.[¶](https://ietf-wg-masque.github.io#section-4.7.1-6.2.1) - IP Version:
-
IP Version of this address assignment, encoded as an unsigned 8-bit integer. It MUST be either 4 or 6.

[¶](https://ietf-wg-masque.github.io#section-4.7.1-6.4.1) - IP Address:
-
...
[¶](https://ietf-wg-masque.github.io#section-4.7.1-6.6.1) - IP Prefix Length:
-
...
[¶](https://ietf-wg-masque.github.io#section-4.7.1-6.8.1)

If any of the capsule fields are malformed upon reception, the receiver of the
capsule MUST follow the error-handling procedure defined in [Section 3.3](https://rfc-editor.org/rfc/rfc9297#section-3.3) of [[HTTP-DGRAM](https://ietf-wg-masque.github.io#HTTP-DGRAM)].[¶](https://ietf-wg-masque.github.io#section-4.7.1-7)
...
all addresses have been removed.[¶](https://ietf-wg-masque.github.io#section-4.7.1-8)
...
packets. For example, in the remote access VPN case ([Section 8.1](https://ietf-wg-masque.github.io#example-remote)), the
...
addresses.[¶](https://ietf-wg-masque.github.io#section-4.7.1-9)

While ADDRESS_ASSIGN capsules are commonly sent in response to ADDRESS_REQUEST
capsules, endpoints MAY send ADDRESS_ASSIGN capsules unprompted.[¶](https://ietf-wg-masque.github.io#section-4.7.1-10)
...
address it would get assigned.[¶](https://ietf-wg-masque.github.io#section-4.7.2-1)

The ADDRESS_REQUEST capsule contains a sequence of one or more Requested
Addresses.[¶](https://ietf-wg-masque.github.io#section-4.7.2-3)

Each Requested Address contains the following fields:[¶](https://ietf-wg-masque.github.io#section-4.7.2-5)
...
[¶](https://ietf-wg-masque.github.io#section-4.7.2-6.2.1) - IP Version:
-
IP Version of this address request, encoded as an unsigned 8-bit integer. It MUST be either 4 or 6.

[¶](https://ietf-wg-masque.github.io#section-4.7.2-6.4.1) - IP Address:
-
...
[¶](https://ietf-wg-masque.github.io#section-4.7.2-6.6.1) - IP Prefix Length:
-
...
[¶](https://ietf-wg-masque.github.io#section-4.7.2-6.8.1)
...
sender's preference for the prefix length it is requesting.[¶](https://ietf-wg-masque.github.io#section-4.7.2-7)

If any of the capsule fields are malformed upon reception, the receiver of the
capsule MUST follow the error-handling procedure defined in [Section 3.3](https://rfc-editor.org/rfc/rfc9297#section-3.3) of [[HTTP-DGRAM](https://ietf-wg-masque.github.io#HTTP-DGRAM)].[¶](https://ietf-wg-masque.github.io#section-4.7.2-8)
...
can also be contained in the same ADDRESS_ASSIGN response.[¶](https://ietf-wg-masque.github.io#section-4.7.2-9)

If an endpoint receives an ADDRESS_REQUEST capsule that contains zero Requested
Addresses, it MUST abort the IP proxying request stream.[¶](https://ietf-wg-masque.github.io#section-4.7.2-10)
...
convey any priority or importance.[¶](https://ietf-wg-masque.github.io#section-4.7.2-11)
...
this capsule.[¶](https://ietf-wg-masque.github.io#section-4.7.3-1)

The ROUTE_ADVERTISEMENT capsule contains a sequence of zero or more IP Address
Ranges.[¶](https://ietf-wg-masque.github.io#section-4.7.3-3)

Each IP Address Range contains the following fields:[¶](https://ietf-wg-masque.github.io#section-4.7.3-5)

- IP Version:
-
IP Version of this range, encoded as an unsigned 8-bit integer. It MUST be either 4 or 6.

[¶](https://ietf-wg-masque.github.io#section-4.7.3-6.2.1) - Start IP Address and End IP Address:
-
...
[¶](https://ietf-wg-masque.github.io#section-4.7.3-6.4.1) - IP Protocol:
-
...
[¶](https://ietf-wg-masque.github.io#section-4.7.3-6.6.1)

If any of the capsule fields are malformed upon reception, the receiver of the
capsule MUST follow the error-handling procedure defined in [Section 3.3](https://rfc-editor.org/rfc/rfc9297#section-3.3) of [[HTTP-DGRAM](https://ietf-wg-masque.github.io#HTTP-DGRAM)].[¶](https://ietf-wg-masque.github.io#section-4.7.3-7)
...
policy), such as by installing entries in a routing table.[¶](https://ietf-wg-masque.github.io#section-4.7.3-8)
...
that range withdrawn.[¶](https://ietf-wg-masque.github.io#section-4.7.3-9)
...
in the same ROUTE_ADVERTISEMENT capsule, they MUST follow these requirements:[¶](https://ietf-wg-masque.github.io#section-4.7.3-10)

- The IP Version of A MUST be less than or equal to the IP Version of B.
[¶](https://ietf-wg-masque.github.io#section-4.7.3-11.1) - If the IP Version of A and B are equal, the IP Protocol of A MUST be less
than or equal to the IP Protocol of B.
[¶](https://ietf-wg-masque.github.io#section-4.7.3-11.2) - If the IP Version and IP Protocol of A and B are both equal, the End IP
Address of A MUST be strictly less than the Start IP Address of B.
[¶](https://ietf-wg-masque.github.io#section-4.7.3-11.3)

If an endpoint receives a ROUTE_ADVERTISEMENT capsule that does not meet these
requirements, it MUST abort the IP proxying request stream.[¶](https://ietf-wg-masque.github.io#section-4.7.3-12)
...
abort the IP proxying request stream.[¶](https://ietf-wg-masque.github.io#section-4.7.3-13)

Both request scoping (see [Section 4.6](https://ietf-wg-masque.github.io#scope)) and the ROUTE_ADVERTISEMENT capsule (see
[Section 4.7.3](https://ietf-wg-masque.github.io#route-adv)) use Internet Protocol Numbers. These numbers represent both upper
layers (as defined in [Section 2](https://rfc-editor.org/rfc/rfc8200#section-2) of [[IPv6](https://ietf-wg-masque.github.io#IPv6)], with examples that include TCP and
UDP) and IPv6 extension headers (as defined in [Section 4](https://rfc-editor.org/rfc/rfc8200#section-4) of [[IPv6](https://ietf-wg-masque.github.io#IPv6)], with examples that
...
([Section 4.3](https://rfc-editor.org/rfc/rfc8200#section-4.3) of [[IPv6](https://ietf-wg-masque.github.io#IPv6)]).[¶](https://ietf-wg-masque.github.io#section-4.8-1)
...
[Section 6](https://ietf-wg-masque.github.io#payload-format).[¶](https://ietf-wg-masque.github.io#section-5-1)

Context IDs are 62-bit integers (0 to 262-1). Context IDs are
encoded as variable-length integers; see [Section 16](https://rfc-editor.org/rfc/rfc9000#section-16) of [[QUIC](https://ietf-wg-masque.github.io#QUIC)]. The Context ID
...
independent of which endpoint initially allocated it.[¶](https://ietf-wg-masque.github.io#section-5-2)
...
datagram and the packet containing the registration message during transmission.[¶](https://ietf-wg-masque.github.io#section-5-3)

When associated with IP proxying request streams, the HTTP Datagram Payload
field of HTTP Datagrams (see [[HTTP-DGRAM](https://ietf-wg-masque.github.io#HTTP-DGRAM)]) has the format defined in
[Figure 13](https://ietf-wg-masque.github.io#dgram-format). Note that, when HTTP Datagrams are encoded using QUIC DATAGRAM
frames, the Context ID field defined below directly follows the Quarter Stream
ID field that is at the start of the QUIC DATAGRAM frame payload:[¶](https://ietf-wg-masque.github.io#section-6-1)

The IP Proxying HTTP Datagram Payload contains the following fields:[¶](https://ietf-wg-masque.github.io#section-6-3)
...
(from the IP Version field until the last byte of the IP payload).[¶](https://ietf-wg-masque.github.io#section-6-5)
...
them to another implementation, such as a kernel.[¶](https://ietf-wg-masque.github.io#section-7-1)

The IP forwarding tunnels described in this document are not fully featured
"interfaces" in the IPv6 addressing architecture sense [[IPv6-ADDR](https://ietf-wg-masque.github.io#IPv6-ADDR)].
...
are not used in such interfaces, and neither is neighbor discovery.[¶](https://ietf-wg-masque.github.io#section-7.1-1)
...
client assumed.[¶](https://ietf-wg-masque.github.io#section-7.1-2)
...
TCP packets.[¶](https://ietf-wg-masque.github.io#section-7.1-3)
...
that rely on external software for routing.[¶](https://ietf-wg-masque.github.io#section-7.2-1)
...
proxying is concerned; see [Section 7.2.1](https://ietf-wg-masque.github.io#error-signal). IP proxying endpoints MAY
implement additional filtering policies on the IP packets they forward.[¶](https://ietf-wg-masque.github.io#section-7.2-2)
...
forwarding checks as above before transmitting the packet over HTTP Datagrams.[¶](https://ietf-wg-masque.github.io#section-7.2-3)
...
presence of routing loops and matches the choices in IPsec [[IPSEC](https://ietf-wg-masque.github.io#IPSEC)].
This does not apply to IP packets generated by the IP proxying endpoint itself.[¶](https://ietf-wg-masque.github.io#section-7.2-4)
...
addresses.[¶](https://ietf-wg-masque.github.io#section-7.2-5)

IPv6 requires that every link have an MTU of at least 1280 bytes [[IPv6](https://ietf-wg-masque.github.io#IPv6)].
...
[[DGRAM](https://ietf-wg-masque.github.io#DGRAM)], the MTU of an IP tunnel can be limited by the MTU of the
...
bytes). This can be accomplished using various techniques:[¶](https://ietf-wg-masque.github.io#section-7.2-6)
...
[¶](https://ietf-wg-masque.github.io#section-7.2-7.1) - IP proxying endpoints can also send ICMPv6 echo requests with 1232 bytes of
...
(ff02::1).
[¶](https://ietf-wg-masque.github.io#section-7.2-7.2)
...
the IP proxying request stream.[¶](https://ietf-wg-masque.github.io#section-7.2-8)
...
[[ICMP](https://ietf-wg-masque.github.io#ICMP)] [[ICMPv6](https://ietf-wg-masque.github.io#ICMPv6)] to signal the forwarding error to its
peer by generating ICMP packets and sending them using HTTP Datagrams.[¶](https://ietf-wg-masque.github.io#section-7.2.1-1)

Endpoints are free to select the most appropriate ICMP errors to send. Some
examples that are relevant for IP proxying include the following:[¶](https://ietf-wg-masque.github.io#section-7.2.1-2)

- For invalid source addresses, send Destination Unreachable (
[Section 3.1](https://rfc-editor.org/rfc/rfc4443#section-3.1)of [[ICMPv6](https://ietf-wg-masque.github.io#ICMPv6)]) with code 5, "Source address failed ingress/egress policy".[¶](https://ietf-wg-masque.github.io#section-7.2.1-3.1) - For unroutable destination addresses, send Destination Unreachable (
[Section 3.1](https://rfc-editor.org/rfc/rfc4443#section-3.1)of [[ICMPv6](https://ietf-wg-masque.github.io#ICMPv6)]) with code 0, "No route to destination", or code 1, "Communication with destination administratively prohibited".[¶](https://ietf-wg-masque.github.io#section-7.2.1-3.2) - For packets that cannot fit within the MTU of the outgoing link, send Packet
Too Big (
[Section 3.2](https://rfc-editor.org/rfc/rfc4443#section-3.2)of [[ICMPv6](https://ietf-wg-masque.github.io#ICMPv6)]).[¶](https://ietf-wg-masque.github.io#section-7.2.1-3.3)
...
peer and also from outside the target if scoping is in use (see [Section 4.6](https://ietf-wg-masque.github.io#scope)).[¶](https://ietf-wg-masque.github.io#section-7.2.1-4)
...
some of the ways in which IP proxying in HTTP can be used.[¶](https://ietf-wg-masque.github.io#section-8-1)
...
IP proxy. Such VPN setups can be either full-tunnel or split-tunnel.[¶](https://ietf-wg-masque.github.io#section-8.1-1)
...
using its assigned address as its source address.[¶](https://ietf-wg-masque.github.io#section-8.1-3)
...
route is restricted to 192.0.2.0/24, rather than 0.0.0.0/0.[¶](https://ietf-wg-masque.github.io#section-8.1-5)
...
provisioned with an IP address from that subnet.[¶](https://ietf-wg-masque.github.io#section-8.2-1)
...
protocols that require that field be set to 255 will not function.[¶](https://ietf-wg-masque.github.io#section-8.2-3)
...
Encapsulating Security Payload (ESP), etc.[¶](https://ietf-wg-masque.github.io#section-8.3-1)
...
request is similar to a regular CONNECT proxy request.[¶](https://ietf-wg-masque.github.io#section-8.3-3)
...
can send and receive SCTP IP packets to the remote host.[¶](https://ietf-wg-masque.github.io#section-8.3-4)
...
an IP proxy, as defined in Happy Eyeballs [[HEv2](https://ietf-wg-masque.github.io#HEv2)]. This example is a
variant of the proxied flow but highlights how IP-level proxying can enable
new capabilities, even for TCP and UDP.[¶](https://ietf-wg-masque.github.io#section-8.4-1)
...
has both IPv4 and IPv6 addresses assigned.[¶](https://ietf-wg-masque.github.io#section-8.4-3)
...
Happy Eyeballs through the IP proxy.[¶](https://ietf-wg-masque.github.io#section-8.4-4)
...
SHOULD behave similarly with regard to the ROUTE_ADVERTISEMENT capsule.[¶](https://ietf-wg-masque.github.io#section-9-1)
...
of hardware offloads.[¶](https://ietf-wg-masque.github.io#section-10-1)

When the protocol running inside the tunnel uses congestion control (e.g.,
[[TCP](https://ietf-wg-masque.github.io#TCP)] or [[QUIC](https://ietf-wg-masque.github.io#QUIC)]), the proxied traffic will incur at least two nested
...
Implementers will benefit from reading the guidance in [Section 3.1.11](https://rfc-editor.org/rfc/rfc8085#section-3.1.11) of [[UDP-USAGE](https://ietf-wg-masque.github.io#UDP-USAGE)].[¶](https://ietf-wg-masque.github.io#section-10-2)

When the protocol running inside the tunnel uses loss recovery (e.g., [[TCP](https://ietf-wg-masque.github.io#TCP)]
or [[QUIC](https://ietf-wg-masque.github.io#QUIC)]) and the outer HTTP connection runs over TCP, the proxied traffic
...
QUIC DATAGRAM frame.[¶](https://ietf-wg-masque.github.io#section-10-3)

When using HTTP/3 with the QUIC Datagram extension [[DGRAM](https://ietf-wg-masque.github.io#DGRAM)], IP packets are
...
(DPLPMTUD) depend on [[DPLPMTUD](https://ietf-wg-masque.github.io#DPLPMTUD)]. In this scenario, the endpoint
SHOULD drop the IP packet and send an ICMP Packet Too Big message to the sender
of the dropped packet; see [Section 3.2](https://rfc-editor.org/rfc/rfc4443#section-3.2) of [[ICMPv6](https://ietf-wg-masque.github.io#ICMPv6)].[¶](https://ietf-wg-masque.github.io#section-10.1-1)
...
Notification (ECN) [[ECN](https://ietf-wg-masque.github.io#ECN)] support on that outer connection. That is,
...
have disabled congestion control.[¶](https://ietf-wg-masque.github.io#section-10.2-1)

Conversely, if congestion control is not disabled on the outer congestion, the
guidance in [[ECN-TUNNEL](https://ietf-wg-masque.github.io#ECN-TUNNEL)] about transferring ECN marks between inner
...
also use ECN, independently of whether it is in use on the outer connection.[¶](https://ietf-wg-masque.github.io#section-10.2-2)

Tunneled IP packets can have Differentiated Services Code Points (DSCPs)
[[DSCP](https://ietf-wg-masque.github.io#DSCP)] set in the traffic class IP header field to request a
...
IP proxying endpoints.[¶](https://ietf-wg-masque.github.io#section-10.3-1)
...
support is left to future extensions.[¶](https://ietf-wg-masque.github.io#section-10.3-2)
...
and egress belonging to the same Differentiated Service domain or not.[¶](https://ietf-wg-masque.github.io#section-10.3-3)
...
[[HTTP](https://ietf-wg-masque.github.io#HTTP)], or even bearer tokens. Proxies can enforce policies for authenticated
...
attributes, such as geographic location.[¶](https://ietf-wg-masque.github.io#section-11-1)
...
possible.[¶](https://ietf-wg-masque.github.io#section-11-2)
...
[[BCP38](https://ietf-wg-masque.github.io#BCP38)] to prevent source address spoofing.[¶](https://ietf-wg-masque.github.io#section-11-3)

Limiting request scope (see [Section 4.6](https://ietf-wg-masque.github.io#scope)) allows two clients to share one of the
...
the client whose scoping matches the invoking packet.[¶](https://ietf-wg-masque.github.io#section-11-4)

Implementers will benefit from reading the guidance in
[[TUNNEL-SECURITY](https://ietf-wg-masque.github.io#TUNNEL-SECURITY)]. Since there are known risks with some IPv6
extension headers (e.g., [[ROUTING-HDR](https://ietf-wg-masque.github.io#ROUTING-HDR)]), implementers need to follow
the latest guidance regarding handling of IPv6 extension headers.[¶](https://ietf-wg-masque.github.io#section-11-5)

Transferring DSCP markings from inner to outer packets (see
[Section 10.3](https://ietf-wg-masque.github.io#dscp-considerations)) exposes end-to-end flow level information to an
...
privacy-sensitive contexts is NOT RECOMMENDED.[¶](https://ietf-wg-masque.github.io#section-11-6)

Opportunistic sending of IP packets (see [Section 7.1](https://ietf-wg-masque.github.io#link-operation)) is not allowed in
...
attacks; see [[OPTIMISTIC](https://ietf-wg-masque.github.io#OPTIMISTIC)]. In
...
successful response.[¶](https://ietf-wg-masque.github.io#section-11-7)

IANA has registered "connect-ip" in the "HTTP Upgrade Tokens" registry
maintained at <[https://www.iana.org/assignments/http-upgrade-tokens](https://www.iana.org/assignments/http-upgrade-tokens)>.[¶](https://ietf-wg-masque.github.io#section-12.1-1)

IANA has created the "MASQUE URI Suffixes" registry maintained at
<[https://www.iana.org/assignments/masque](https://www.iana.org/assignments/masque)>. The registration policy is
Expert Review; see [Section 4.5](https://rfc-editor.org/rfc/rfc8126#section-4.5) of [[IANA-POLICY](https://ietf-wg-masque.github.io#IANA-POLICY)]. This new registry
governs the path segment that immediately follows "masque" in paths that start
with "/.well-known/masque/"; see
<[https://www.iana.org/assignments/well-known-uris](https://www.iana.org/assignments/well-known-uris)> for the registration of
"masque" in the "Well-Known URIs" registry.[¶](https://ietf-wg-masque.github.io#section-12.2-1)

This new registry contains three columns:[¶](https://ietf-wg-masque.github.io#section-12.2-2)

- Path Segment:
-
An ASCII string containing only characters allowed in tokens; see

[Section 5.6.2](https://rfc-editor.org/rfc/rfc9110#section-5.6.2)of [[HTTP](https://ietf-wg-masque.github.io#HTTP)]. Entries in this registry MUST all have distinct entries in this column.[¶](https://ietf-wg-masque.github.io#section-12.2-3.2.1) - Description:
-
A description of the entry.

[¶](https://ietf-wg-masque.github.io#section-12.2-3.4.1) - Reference:
-
An optional reference defining the use of the entry.

[¶](https://ietf-wg-masque.github.io#section-12.2-3.6.1)

The registry's initial entries are as follows:[¶](https://ietf-wg-masque.github.io#section-12.2-4)
...
the use case is relevant to proxying.[¶](https://ietf-wg-masque.github.io#section-12.2-6)

IANA has updated the entry for the "masque" URI suffix
in the "Well-Known URIs" registry maintained at
<[https://www.iana.org/assignments/well-known-uris](https://www.iana.org/assignments/well-known-uris)>.[¶](https://ietf-wg-masque.github.io#section-12.3-1)
...
<[https://www.iana.org/assignments/masque](https://www.iana.org/assignments/masque)>.".[¶](https://ietf-wg-masque.github.io#section-12.3-2)

IANA has added the following values to the "HTTP Capsule
Types" registry maintained at
<[https://www.iana.org/assignments/masque](https://www.iana.org/assignments/masque)>.[¶](https://ietf-wg-masque.github.io#section-12.4-1)
...
All of these new entries use the following values for these fields:[¶](https://ietf-wg-masque.github.io#section-12.4-3)

- [ABNF]
-
Crocker, D., Ed. and P. Overell, "Augmented BNF for Syntax Specifications: ABNF", STD 68, RFC 5234, DOI 10.17487/RFC5234, , <
[https://www.rfc-editor.org/rfc/rfc5234](https://www.rfc-editor.org/rfc/rfc5234)>. - [BCP38]
-
...
[https://www.rfc-editor.org/rfc/rfc2827](https://www.rfc-editor.org/rfc/rfc2827)>. - [DGRAM]
-
Pauly, T., Kinnear, E., and D. Schinazi, "An Unreliable Datagram Extension to QUIC", RFC 9221, DOI 10.17487/RFC9221, , <
[https://www.rfc-editor.org/rfc/rfc9221](https://www.rfc-editor.org/rfc/rfc9221)>. - [DSCP]
-
...
[https://www.rfc-editor.org/rfc/rfc2474](https://www.rfc-editor.org/rfc/rfc2474)>. - [ECN]
-
...
[https://www.rfc-editor.org/rfc/rfc3168](https://www.rfc-editor.org/rfc/rfc3168)>. - [EXT-CONNECT2]
-
McManus, P., "Bootstrapping WebSockets with HTTP/2", RFC 8441, DOI 10.17487/RFC8441, , <
[https://www.rfc-editor.org/rfc/rfc8441](https://www.rfc-editor.org/rfc/rfc8441)>. - [EXT-CONNECT3]
-
Hamilton, R., "Bootstrapping WebSockets with HTTP/3", RFC 9220, DOI 10.17487/RFC9220, , <
[https://www.rfc-editor.org/rfc/rfc9220](https://www.rfc-editor.org/rfc/rfc9220)>. - [HTTP]
-
Fielding, R., Ed., Nottingham, M., Ed., and J. Reschke, Ed., "HTTP Semantics", STD 97, RFC 9110, DOI 10.17487/RFC9110, , <
[https://www.rfc-editor.org/rfc/rfc9110](https://www.rfc-editor.org/rfc/rfc9110)>. - [HTTP-DGRAM]
-
Schinazi, D. and L. Pardue, "HTTP Datagrams and the Capsule Protocol", RFC 9297, DOI 10.17487/RFC9297, , <
[https://www.rfc-editor.org/rfc/rfc9297](https://www.rfc-editor.org/rfc/rfc9297)>. - [HTTP/1.1]
-
Fielding, R., Ed., Nottingham, M., Ed., and J. Reschke, Ed., "HTTP/1.1", STD 99, RFC 9112, DOI 10.17487/RFC9112, , <
[https://www.rfc-editor.org/rfc/rfc9112](https://www.rfc-editor.org/rfc/rfc9112)>. - [HTTP/2]
-
Thomson, M., Ed. and C. Benfield, Ed., "HTTP/2", RFC 9113, DOI 10.17487/RFC9113, , <
[https://www.rfc-editor.org/rfc/rfc9113](https://www.rfc-editor.org/rfc/rfc9113)>. - [HTTP/3]
-
Bishop, M., Ed., "HTTP/3", RFC 9114, DOI 10.17487/RFC9114, , <
[https://www.rfc-editor.org/rfc/rfc9114](https://www.rfc-editor.org/rfc/rfc9114)>. - [IANA-POLICY]
-
...
[https://www.rfc-editor.org/rfc/rfc8126](https://www.rfc-editor.org/rfc/rfc8126)>. - [ICMP]
-
Postel, J., "Internet Control Message Protocol", STD 5, RFC 792, DOI 10.17487/RFC0792, , <
[https://www.rfc-editor.org/rfc/rfc792](https://www.rfc-editor.org/rfc/rfc792)>. - [ICMPv6]
-
...
[https://www.rfc-editor.org/rfc/rfc4443](https://www.rfc-editor.org/rfc/rfc4443)>. - [IPv6]
-
Deering, S. and R. Hinden, "Internet Protocol, Version 6 (IPv6) Specification", STD 86, RFC 8200, DOI 10.17487/RFC8200, , <
[https://www.rfc-editor.org/rfc/rfc8200](https://www.rfc-editor.org/rfc/rfc8200)>. - [IPv6-ZONE-ID]
-
...
[https://www.rfc-editor.org/rfc/rfc6874](https://www.rfc-editor.org/rfc/rfc6874)>. - [PROXY-STATUS]
-
Nottingham, M. and P. Sikora, "The Proxy-Status HTTP Response Header Field", RFC 9209, DOI 10.17487/RFC9209, , <
[https://www.rfc-editor.org/rfc/rfc9209](https://www.rfc-editor.org/rfc/rfc9209)>. - [QUIC]
-
Iyengar, J., Ed. and M. Thomson, Ed., "QUIC: A UDP-Based Multiplexed and Secure Transport", RFC 9000, DOI 10.17487/RFC9000, , <
[https://www.rfc-editor.org/rfc/rfc9000](https://www.rfc-editor.org/rfc/rfc9000)>. - [RFC2119]
-
Bradner, S., "Key words for use in RFCs to Indicate Requirement Levels", BCP 14, RFC 2119, DOI 10.17487/RFC2119, , <
[https://www.rfc-editor.org/rfc/rfc2119](https://www.rfc-editor.org/rfc/rfc2119)>. - [RFC8174]
-
Leiba, B., "Ambiguity of Uppercase vs Lowercase in RFC 2119 Key Words", BCP 14, RFC 8174, DOI 10.17487/RFC8174, , <
[https://www.rfc-editor.org/rfc/rfc8174](https://www.rfc-editor.org/rfc/rfc8174)>. - [TCP]
-
Eddy, W., Ed., "Transmission Control Protocol (TCP)", STD 7, RFC 9293, DOI 10.17487/RFC9293, , <
[https://www.rfc-editor.org/rfc/rfc9293](https://www.rfc-editor.org/rfc/rfc9293)>. - [TEMPLATE]
-
Gregorio, J., Fielding, R., Hadley, M., Nottingham, M., and D. Orchard, "URI Template", RFC 6570, DOI 10.17487/RFC6570, , <
[https://www.rfc-editor.org/rfc/rfc6570](https://www.rfc-editor.org/rfc/rfc6570)>. - [URI]
-
...
[https://www.rfc-editor.org/rfc/rfc9298](https://www.rfc-editor.org/rfc/rfc9298)>. - [DPLPMTUD]
-
...
[https://www.rfc-editor.org/rfc/rfc8899](https://www.rfc-editor.org/rfc/rfc8899)>. - [ECN-TUNNEL]
-
Briscoe, B., "Tunnelling of Explicit Congestion Notification", RFC 6040, DOI 10.17487/RFC6040, , <
[https://www.rfc-editor.org/rfc/rfc6040](https://www.rfc-editor.org/rfc/rfc6040)>. - [HEv2]
-
Schinazi, D. and T. Pauly, "Happy Eyeballs Version 2: Better Connectivity Using Concurrency", RFC 8305, DOI 10.17487/RFC8305, , <
[https://www.rfc-editor.org/rfc/rfc8305](https://www.rfc-editor.org/rfc/rfc8305)>. - [IANA-PN]
-
IANA, "Protocol Numbers", <
[https://www.iana.org/assignments/protocol-numbers](https://www.iana.org/assignments/protocol-numbers)>. - [IPSEC]
-
Kent, S. and K. Seo, "Security Architecture for the Internet Protocol", RFC 4301, DOI 10.17487/RFC4301, , <
[https://www.rfc-editor.org/rfc/rfc4301](https://www.rfc-editor.org/rfc/rfc4301)>. - [IPv6-ADDR]
-
Hinden, R. and S. Deering, "IP Version 6 Addressing Architecture", RFC 4291, DOI 10.17487/RFC4291, , <
[https://www.rfc-editor.org/rfc/rfc4291](https://www.rfc-editor.org/rfc/rfc4291)>. - [OPTIMISTIC]
-
Schwartz, B. M., "Security Considerations for Optimistic Use of HTTP Upgrade", Work in Progress, Internet-Draft, draft-schwartz-httpbis-optimistic-upgrade-00, , <
[https://datatracker.ietf.org/doc/html/draft-schwartz-httpbis-optimistic-upgrade-00](https://datatracker.ietf.org/doc/html/draft-schwartz-httpbis-optimistic-upgrade-00)>. - [PROXY-REQS]
-
Chernyakhovsky, A., McCall, D., and D. Schinazi, "Requirements for a MASQUE Protocol to Proxy IP Traffic", Work in Progress, Internet-Draft, draft-ietf-masque-ip-proxy-reqs-03, , <
[https://datatracker.ietf.org/doc/html/draft-ietf-masque-ip-proxy-reqs-03](https://datatracker.ietf.org/doc/html/draft-ietf-masque-ip-proxy-reqs-03)>. - [ROUTING-HDR]
-
Abley, J., Savola, P., and G. Neville-Neil, "Deprecation of Type 0 Routing Headers in IPv6", RFC 5095, DOI 10.17487/RFC5095, , <
[https://www.rfc-editor.org/rfc/rfc5095](https://www.rfc-editor.org/rfc/rfc5095)>. - [TUNNEL-SECURITY]
-
Krishnan, S., Thaler, D., and J. Hoagland, "Security Concerns with IP Tunneling", RFC 6169, DOI 10.17487/RFC6169, , <
[https://www.rfc-editor.org/rfc/rfc6169](https://www.rfc-editor.org/rfc/rfc6169)>. - [UDP-USAGE]
-
Eggert, L., Fairhurst, G., and G. Shepherd, "UDP Usage Guidelines", BCP 145, RFC 8085, DOI 10.17487/RFC8085, , <
[https://www.rfc-editor.org/rfc/rfc8085](https://www.rfc-editor.org/rfc/rfc8085)>.

The design of this method was inspired by discussions in the MASQUE Working
Group around [[PROXY-REQS](https://ietf-wg-masque.github.io#PROXY-REQS)]. The authors would
...
provided valuable feedback on the document.[¶](https://ietf-wg-masque.github.io#appendix-A-1)

Most of the text on client configuration is based on the corresponding text in
[[CONNECT-UDP](https://ietf-wg-masque.github.io#CONNECT-UDP)].[¶](https://ietf-wg-masque.github.io#appendix-A-2)
