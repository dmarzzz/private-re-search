---
url: https://arxiv.org/html/2501.14342v3
title: Chain-of-Retrieval Augmented Generation
fetched_at: 2026-05-30T19:38:16
content_hash: sha1:9332ea9c74eb4b60f41064047643490641b34795
...
This paper introduces an approach for training o1-like RAG models that retrieve and reason over relevant information step by step before generating the final answer. Conventional RAG methods usually perform a single retrieval step before the generation process, which limits their effectiveness in addressing complex queries due to imperfect retrieval results. In contrast, our proposed method, CoRAG (Chain-of-Retrieval Augmented Generation), allows the model to dynamically reformulate the query based on the evolving state. To train CoRAG effectively, we utilize rejection sampling to automatically generate intermediate retrieval chains, thereby augmenting existing RAG datasets that only provide the correct final answer. At test time, we propose various decoding strategies to scale the model’s test-time compute by controlling the length and number of sampled retrieval chains. Experimental results across multiple benchmarks validate the efficacy of CoRAG, particularly in multi-hop question answering tasks, where we observe more than points improvement in EM score compared to strong baselines. On the KILT benchmark, CoRAG establishes a new state-of-the-art performance across a diverse range of knowledge-intensive tasks. Furthermore, we offer comprehensive analyses to understand the scaling behavior of CoRAG, laying the groundwork for future research aimed at developing factual and grounded foundation models.

## 1 Introduction

Retrieval-augmented generation (RAG) [[20](https://arxiv.org/html/2501.14342v3#bib.bib20)] is one of the core techniques in enterprise applications,
...
For instance,
dense retrievers [[18](https://arxiv.org/html/2501.14342v3#bib.bib18), [35](https://arxiv.org/html/2501.14342v3#bib.bib35)]
commonly utilize a bi-encoder architecture to compress documents and queries into fixed-size vector representations.
...
An example is illustrated in Figure [1](https://arxiv.org/html/2501.14342v3#S0.F1).

Rather than solely relying on the model’s in-context learning capability [[42](https://arxiv.org/html/2501.14342v3#bib.bib42)]
or distillation from proprietary models [[1](https://arxiv.org/html/2501.14342v3#bib.bib1)],
we advocate for explicitly training language models to retrieve step by step.
To this end,
we utilize rejection sampling [[43](https://arxiv.org/html/2501.14342v3#bib.bib43), [5](https://arxiv.org/html/2501.14342v3#bib.bib5)]
to augment existing RAG datasets with intermediate retrieval chains.
...
including greedy decoding, best-of- sampling, and tree search.
...
On the KILT benchmark [[27](https://arxiv.org/html/2501.14342v3#bib.bib27)],
...
For datasets such as NQ [[19](https://arxiv.org/html/2501.14342v3#bib.bib19)],
...
Our code, data and trained models are available at [https://github.com/microsoft/LMOps/tree/main/corag](https://github.com/microsoft/LMOps/tree/main/corag).

## 2 Related Work

Retrieval-Augmented Generation (RAG)
integrates information retrieval techniques with generative models to
enhance the quality and factual accuracy of generated content [[20](https://arxiv.org/html/2501.14342v3#bib.bib20), [21](https://arxiv.org/html/2501.14342v3#bib.bib21)].
By equipping LLMs with the ability to browse the web [[26](https://arxiv.org/html/2501.14342v3#bib.bib26)],
...
A substantial body of recent research has concentrated on developing better general-purpose text embeddings [[18](https://arxiv.org/html/2501.14342v3#bib.bib18), [35](https://arxiv.org/html/2501.14342v3#bib.bib35)].
Nevertheless,
...
advancing to multi-step iterative retrieval and generation [[6](https://arxiv.org/html/2501.14342v3#bib.bib6)].
FLARE [[13](https://arxiv.org/html/2501.14342v3#bib.bib13)] prompts an LLM to actively determine when and what to retrieve during the generation process.
ITER-RETGEN [[30](https://arxiv.org/html/2501.14342v3#bib.bib30)] proposes to interleave retrieval-augmented generation with generation-augmented retrieval,
demonstrating enhancements in multi-hop QA tasks.
Similarly,
IRCoT [[33](https://arxiv.org/html/2501.14342v3#bib.bib33)] employs a chain-of-thought methodology,
which recursively refines the reasoning thought for subsequent retrieval steps.
Self-RAG [[1](https://arxiv.org/html/2501.14342v3#bib.bib1)] empowers LLMs to adaptively retrieve, generate, and critique through self-reflection,
thus improving factual accuracy and citation precision in open-domain QA and long-form generation tasks.
Auto-RAG [[41](https://arxiv.org/html/2501.14342v3#bib.bib41)] utilizes heuristic rules and exact answer matching to construct intermediate retrieval steps,
yet its performance remains significantly below that of state-of-the-art models.
AQA [[3](https://arxiv.org/html/2501.14342v3#bib.bib3)] learns to reformulate questions using reinforcement learning
...
Instead of prompting LLMs to directly generate the final answer,
Chain-of-Thought (CoT) [[36](https://arxiv.org/html/2501.14342v3#bib.bib36)] demonstrates that letting the model to think step by step
can drastically improve the performance on mathematical reasoning tasks.
Tree-of-Thought (ToT) [[40](https://arxiv.org/html/2501.14342v3#bib.bib40)] extends the idea of CoT by adopting a tree structure,
allowing the model to explore the search space more comprehensively.
To further enhance the reasoning capabilities of LLMs,
STaR [[43](https://arxiv.org/html/2501.14342v3#bib.bib43)] proposes to leverage bootstrapping techniques to generate intermediate states for training.
OpenAI o1 [[12](https://arxiv.org/html/2501.14342v3#bib.bib12)] conducts large-scale reinforcement learning
...
LongRAG [[14](https://arxiv.org/html/2501.14342v3#bib.bib14)] posits that RAG performance can be enhanced by
integrating long-context LLMs with more retrieved documents.
In contrast,
IterDRAG [[42](https://arxiv.org/html/2501.14342v3#bib.bib42)] empirically examines the test-time scaling law
through few-shot prompting and iterative retrieval for up to M tokens.
Search-o1 [[22](https://arxiv.org/html/2501.14342v3#bib.bib22)] combines the open-source QwQ model [[37](https://arxiv.org/html/2501.14342v3#bib.bib37)]
with active search from Bing,
achieving competitive results on knowledge-intensive tasks.
Concurrent works such as Search-R1 [[15](https://arxiv.org/html/2501.14342v3#bib.bib15)] train LLMs to use retrieval as a tool via reinforcement learning.
...
The CoRAG framework is illustrated in Figure [2](https://arxiv.org/html/2501.14342v3#S3.F2).
...
Most RAG datasets only come with a query and the corresponding final answer , without providing intermediate retrieval steps. We propose an automated method for generating retrieval chains through rejection sampling. Each sampled chain consists of a sequence of sub-queries and the corresponding sub-answers , where is a predetermined maximum chain length. The sub-query is generated by sampling an LLM based on the query and the preceding sub-queries and sub-answers. To generate the sub-answer , we first retrieve the top- most relevant documents using a text retriever with as the search query, and subsequently prompt an LLM to yield the answer . This procedure is iterated until the chain reaches the maximum length or matches the correct answer .

To assess the quality of a retrieval chain, we calculate the log-likelihood of the correct answer conditioned on the chain information. The retrieval chain with the highest log-likelihood score is selected to augment the original QA-only dataset.

### 3.2 Training

Each training instance in the augmented dataset is represented as a tuple , accompanied by the corresponding top- retrieved documents for the query and each sub-query. We fine-tune an LLM on the augmented dataset using the standard next-token prediction objective within a unified multi-task learning framework.

The model is simultaneously trained on three tasks: next sub-query prediction, sub-answer prediction, and final answer prediction. We employ the same prompt templates as utilized in the retrieval chain generation process, with the exception that we also incorporate the top retrieved documents for the original query as input for the final answer prediction task.
...
Unlike previous approaches that consider only prompt tokens [[42](https://arxiv.org/html/2501.14342v3#bib.bib42)] or generated tokens [[12](https://arxiv.org/html/2501.14342v3#bib.bib12)],
we account for both.
...
Greedy Decoding This strategy utilizes greedy decoding to generate sub-queries and their corresponding sub-answers sequentially. The final answer is generated using the same prompt template as employed during the training phase.

Best-of- Sampling
This method involves sampling retrieval chains with a temperature ,
...
To control the test-time compute, the maximum length of the retrieval chain can be adjusted across all decoding strategies. For best-of- sampling, the number of sampled chains offers an alternative option to scale the test-time compute. In tree search, the number of rollouts and expansion size are two additional hyperparameters.
...
Data and Evaluation
We evaluate CoRAG utilizing two sets of benchmarks:
(1) a collection of multi-hop QA datasets,
including 2WikiMultihopQA [[8](https://arxiv.org/html/2501.14342v3#bib.bib8)],
HotpotQA [[39](https://arxiv.org/html/2501.14342v3#bib.bib39)], Bamboogle [[28](https://arxiv.org/html/2501.14342v3#bib.bib28)], and MuSiQue [[32](https://arxiv.org/html/2501.14342v3#bib.bib32)];
(2) the KILT benchmark [[27](https://arxiv.org/html/2501.14342v3#bib.bib27)],
...
We utilize E5-large [[34](https://arxiv.org/html/2501.14342v3#bib.bib34)] as the text retriever for intermediate retrieval steps.
The retrieval corpus is the English Wikipedia provided by KILT,
comprising approximately million passages [[25](https://arxiv.org/html/2501.14342v3#bib.bib25)].
...
we report the exact match (EM) and F1 scores [[29](https://arxiv.org/html/2501.14342v3#bib.bib29)] for the multi-hop QA datasets.
...
Model Training
We conduct full-parameter fine-tuning on the augmented datasets,
...
The compiled multi-hop QA dataset comprises k training instances,
whereas the KILT benchmark includes k instances after sub-sampling.
The model is fine-tuned for epoch with a maximum sequence length of k tokens.
For the KILT benchmark,
we fine-tune an E5-Mistral retriever [[35](https://arxiv.org/html/2501.14342v3#bib.bib35)] and
a RankLLaMA re-ranker [[24](https://arxiv.org/html/2501.14342v3#bib.bib24)] on the respective training set to boost the ranking quality.

Further implementation details are provided in Appendix [A](https://arxiv.org/html/2501.14342v3#A1).

### 4.2 Main Results

[31](https://arxiv.org/html/2501.14342v3#bib.bib31)], while Search-o1-32B is based on QwQ [

[37](https://arxiv.org/html/2501.14342v3#bib.bib37)] and the Bing Search API.
...
Multi-hop QA
In Table [1](https://arxiv.org/html/2501.14342v3#S4.T1),
we present a comparative analysis of CoRAG-8B against several models,
including few-shot Llama-3.1-8B-Instruct [[5](https://arxiv.org/html/2501.14342v3#bib.bib5)], GPT-4o [[10](https://arxiv.org/html/2501.14342v3#bib.bib10)],
Self-RAG-7B [[1](https://arxiv.org/html/2501.14342v3#bib.bib1)], ITER-RETGEN [[30](https://arxiv.org/html/2501.14342v3#bib.bib30)],
DRAG, IterDRAG [[42](https://arxiv.org/html/2501.14342v3#bib.bib42)], and Search-o1-32B [[22](https://arxiv.org/html/2501.14342v3#bib.bib22)].
...
The Bamboogle dataset comprises only instances, resulting in considerable variance in performance across different runs. Certain questions within Bamboogle necessitate access to knowledge more recent than the Wikipedia dump used for retrieval. Systems like Search-o1-32B, which rely on commercial search engines, possess an advantage in this regard.

*hidden test set*of the KILT benchmark. All scores are sourced directly from the official leaderboard, with the exception that “RA-DIT 65B” is from the original paper [

[23](https://arxiv.org/html/2501.14342v3#bib.bib23)]. : “Previous Best” refers to the highest score for each task on the public KILT leaderboard as of January 10, 2025.
...
Previous Best∗
|
90.6 | 87.4 | 71.2 | 87.7 | 85.3 | 62.3 | 50.6 | 84.6 | 93.5 |
| CoRAG-8B (Ours) | 93.9 | 88.2 | 76.7 | 88.0 | 87.2 | 63.1 | 60.6 | 88.3 | 93.1 |

KILT Benchmark
We present several strong systems on the KILT benchmark in Table [2](https://arxiv.org/html/2501.14342v3#S4.T2),
including KILT-RAG [[27](https://arxiv.org/html/2501.14342v3#bib.bib27)], SEAL [[2](https://arxiv.org/html/2501.14342v3#bib.bib2)],
Atlas-11B [[11](https://arxiv.org/html/2501.14342v3#bib.bib11)], RA-DIT 65B [[23](https://arxiv.org/html/2501.14342v3#bib.bib23)], and FiD with RS [[9](https://arxiv.org/html/2501.14342v3#bib.bib9)].
...
The results of different decoding strategies are detailed in Appendix Table [7](https://arxiv.org/html/2501.14342v3#A2.T7).
...
*Pareto optimal*if no other point achieves a higher EM score with less token consumption. The metric “# Avg. Tokens” represents the average number of tokens consumed per test instance, summing up both the prompt and generated tokens.

In alignment with OpenAI o1 [[12](https://arxiv.org/html/2501.14342v3#bib.bib12)],
...
In Figure [3](https://arxiv.org/html/2501.14342v3#S4.F3),
we concentrate on two factors:
the retrieval chain length and the number of sampled chains for best-of- sampling.
Greedy decoding is a special instance of best-of- sampling with and the temperature set to .

We observe that increasing the retrieval chain length results in
substantial performance improvements when is small,
but the gains diminish as increases.
...
akin to the iterative rejection sampling employed in LLM post-training [[5](https://arxiv.org/html/2501.14342v3#bib.bib5)].
...
However,
the results in Table [3](https://arxiv.org/html/2501.14342v3#S5.T3) are mixed,
...
Weak-to-strong Generalization
Due to the need of repeated sampling and autoregressive generation,
...
similar to the weak-to-strong generalization setting [[4](https://arxiv.org/html/2501.14342v3#bib.bib4)].

The results in Table [3](https://arxiv.org/html/2501.14342v3#S5.T3) demonstrate that utilizing Llama-3B
achieves very close performance compared to the 8B model,
whereas Llama-1B exhibits a noticeable performance drop.
Manual inspection reveals that the B model frequently struggles to follow the given instructions,
...
which show great potential in mathematical reasoning tasks [[7](https://arxiv.org/html/2501.14342v3#bib.bib7)].
In contrast,
...
Table [1](https://arxiv.org/html/2501.14342v3#S4.T1) presents empirical evidence supporting this assertion.
In contrast,
for tasks that a single retrieval step is typically sufficient,
the advantage tends to be marginal,
as demonstrated in Figure [4](https://arxiv.org/html/2501.14342v3#S5.F4).
Datasets such as NQ [[19](https://arxiv.org/html/2501.14342v3#bib.bib19)] and TriviaQA [[17](https://arxiv.org/html/2501.14342v3#bib.bib17)]
are known for their (mostly) single-hop nature.
This phenomenon implies that decoding strategies should be adaptive based on the complexity of the query.
Additional results on the full KILT benchmark are listed in Appendix Table [7](https://arxiv.org/html/2501.14342v3#A2.T7),
where similar observations for other task types also hold.

### 5.4 Learning to Stop at Test Time

Instead of always performing retrieval steps,
...
and “*No*” otherwise.
The associated prompt template is in Appendix Section [D](https://arxiv.org/html/2501.14342v3#A4).

In Figure [5](https://arxiv.org/html/2501.14342v3#S5.F5),
...
We report Recall@k metrics for ,
comparing standard retrieval using E5 against our approach.
We follow the evaluation protocol from DPR [[18](https://arxiv.org/html/2501.14342v3#bib.bib18)] for calculating recall based on answer matches,
...
| R@10 | R@20 | R@100 | |
|---|---|---|---|
| HotpotQA w/ E5 | 59.1 | 65.2 | 76.8 |
| w/ CoRAG | 72.1 | 76.7 | 84.3 |
| 2WikiMultiHopQA w/ E5 | 54.9 | 62.1 | 74.6 |
| w/ CoRAG | 81.4 | 84.8 | 88.8 |
| Bamboogle w/ E5 | 31.2 | 40.0 | 57.6 |
| w/ CoRAG | 59.2 | 68.0 | 75.2 |
| MuSiQue w/ E5 | 29.0 | 36.5 | 52.7 |
| w/ CoRAG | 47.1 | 54.6 | 68.4 |

The results in Table [4](https://arxiv.org/html/2501.14342v3#S5.T4) demonstrate that CoRAG consistently improves recall across all datasets and recall thresholds.
...
In
*The Twelfth International Conference on Learning Representations, ICLR 2024, Vienna, Austria, May 7-11, 2024*. OpenReview.net, 2024. URL[https://openreview.net/forum?id=hSyW5go0v8](https://openreview.net/forum?id=hSyW5go0v8). -
Bevilacqua et al. [2022]
Michele Bevilacqua, Giuseppe Ottaviano, Patrick S. H. Lewis, Scott Yih, Sebastian Riedel, and Fabio Petroni.
...
In
*Forty-first International Conference on Machine Learning, ICML 2024, Vienna, Austria, July 21-27, 2024*. OpenReview.net, 2024. URL[https://openreview.net/forum?id=ghNRg2mEgN](https://openreview.net/forum?id=ghNRg2mEgN). -
Dubey et al. [2024]
Abhimanyu Dubey, Abhinav Jauhri, Abhinav Pandey, Abhishek Kadian, Ahmad Al-Dahle, Aiesha Letman, Akhil Mathur, Alan Schelten, Amy Yang, Angela Fan, et al.
The llama 3 herd of models.
*ArXiv preprint*, abs/2407.21783, 2024. URL[https://arxiv.org/abs/2407.21783](https://arxiv.org/abs/2407.21783). -
Gao et al. [2023]
...
*ArXiv preprint*, abs/2312.10997, 2023. URL[https://arxiv.org/abs/2312.10997](https://arxiv.org/abs/2312.10997). -
Guan et al. [2025]
Xinyu Guan, Li Lyna Zhang, Yifei Liu, Ning Shang, Youran Sun, Yi Zhu, Fan Yang, and Mao Yang.
rstar-math: Small llms can master math reasoning with self-evolved deep thinking.
*ArXiv preprint*, abs/2501.04519, 2025. URL[https://arxiv.org/abs/2501.04519](https://arxiv.org/abs/2501.04519). -
Ho et al. [2020]
Xanh Ho, Anh-Khoa Duong Nguyen, Saku Sugawara, and Akiko Aizawa.
Constructing a multi-hop QA dataset for comprehensive evaluation of reasoning steps.
In Donia Scott, Nuria Bel, and Chengqing Zong, editors,
...
*ArXiv preprint*, abs/2207.03030, 2022. URL[https://arxiv.org/abs/2207.03030](https://arxiv.org/abs/2207.03030). -
Hurst et al. [2024]
...
Gpt-4o system card.
*ArXiv preprint*, abs/2410.21276, 2024. URL[https://arxiv.org/abs/2410.21276](https://arxiv.org/abs/2410.21276). -
Izacard et al. [2023]
...
*ArXiv preprint*, abs/2412.16720, 2024. URL[https://arxiv.org/abs/2412.16720](https://arxiv.org/abs/2412.16720). -
Jiang et al. [2023]
...
*Proceedings of the 2023 Conference on Empirical Methods in Natural Language Processing*, pages 7969–7992, Singapore, 2023. Association for Computational Linguistics. doi: 10.18653/v1/2023.emnlp-main.495. URL[https://aclanthology.org/2023.emnlp-main.495](https://aclanthology.org/2023.emnlp-main.495). -
Jiang et al. [2024]
Ziyan Jiang, Xueguang Ma, and Wenhu Chen.
Longrag: Enhancing retrieval-augmented generation with long-context llms.
*ArXiv preprint*, abs/2406.15319, 2024. URL[https://arxiv.org/abs/2406.15319](https://arxiv.org/abs/2406.15319). -
Jin et al. [2025]
...
*ArXiv preprint*, abs/2405.13576, 2024. URL[https://arxiv.org/abs/2405.13576](https://arxiv.org/abs/2405.13576). -
Joshi et al. [2017]
Mandar Joshi, Eunsol Choi, Daniel Weld, and Luke Zettlemoyer.
TriviaQA: A large scale distantly supervised challenge dataset for reading comprehension.
In Regina Barzilay and Min-Yen Kan, editors,
*Proceedings of the 55th Annual Meeting of the Association for Computational Linguistics (Volume 1: Long Papers)*, pages 1601–1611, Vancouver, Canada, 2017. Association for Computational Linguistics. doi: 10.18653/v1/P17-1147. URL[https://aclanthology.org/P17-1147](https://aclanthology.org/P17-1147). -
...
*Proceedings of the 2020 Conference on Empirical Methods in Natural Language Processing (EMNLP)*, pages 6769–6781, Online, 2020. Association for Computational Linguistics. doi: 10.18653/v1/2020.emnlp-main.550. URL[https://aclanthology.org/2020.emnlp-main.550](https://aclanthology.org/2020.emnlp-main.550). -
...
*Transactions of the Association for Computational Linguistics*, 7:452–466, 2019. doi: 10.1162/tacl_a_00276. URL[https://aclanthology.org/Q19-1026](https://aclanthology.org/Q19-1026). -
Lewis et al. [2020]
...
*ArXiv preprint*, abs/2404.14851, 2024. URL[https://arxiv.org/abs/2404.14851](https://arxiv.org/abs/2404.14851). -
Li et al. [2025]
Xiaoxi Li, Guanting Dong, Jiajie Jin, Yuyao Zhang, Yujia Zhou, Yutao Zhu, Peitian Zhang, and Zhicheng Dou.
Search-o1: Agentic search-enhanced large reasoning models.
*ArXiv preprint*, abs/2501.05366, 2025. URL[https://arxiv.org/abs/2501.05366](https://arxiv.org/abs/2501.05366). -
Lin et al. [2024]
...
In
*The Twelfth International Conference on Learning Representations, ICLR 2024, Vienna, Austria, May 7-11, 2024*. OpenReview.net, 2024. URL[https://openreview.net/forum?id=22OTbutug9](https://openreview.net/forum?id=22OTbutug9). -
Ma et al. [2024]
Xueguang Ma, Liang Wang, Nan Yang, Furu Wei, and Jimmy Lin.
Fine-tuning llama for multi-stage text retrieval.
In Grace Hui Yang, Hongning Wang, Sam Han, Claudia Hauff, Guido Zuccon, and Yi Zhang, editors,
*Proceedings of the 47th International ACM SIGIR Conference on Research and Development in Information Retrieval, SIGIR 2024, Washington DC, USA, July 14-18, 2024*, pages 2421–2425. ACM, 2024. doi: 10.1145/3626772.3657951. URL[https://doi.org/10.1145/3626772.3657951](https://doi.org/10.1145/3626772.3657951). -
Maillard et al. [2021]
...
*Proceedings of the 59th Annual Meeting of the Association for Computational Linguistics and the 11th International Joint Conference on Natural Language Processing (Volume 1: Long Papers)*, pages 1098–1111, Online, 2021. Association for Computational Linguistics. doi: 10.18653/v1/2021.acl-long.89. URL[https://aclanthology.org/2021.acl-long.89](https://aclanthology.org/2021.acl-long.89). -
Nakano et al. [2021]
...
*ArXiv preprint*, abs/2112.09332, 2021. URL[https://arxiv.org/abs/2112.09332](https://arxiv.org/abs/2112.09332). -
Petroni et al. [2021]
...
*Proceedings of the 2021 Conference of the North American Chapter of the Association for Computational Linguistics: Human Language Technologies*, pages 2523–2544, Online, 2021. Association for Computational Linguistics. doi: 10.18653/v1/2021.naacl-main.200. URL[https://aclanthology.org/2021.naacl-main.200](https://aclanthology.org/2021.naacl-main.200). -
Press et al. [2023]
Ofir Press, Muru Zhang, Sewon Min, Ludwig Schmidt, Noah Smith, and Mike Lewis.
Measuring and narrowing the compositionality gap in language models.
In Houda Bouamor, Juan Pino, and Kalika Bali, editors,
*Findings of the Association for Computational Linguistics: EMNLP 2023*, pages 5687–5711, Singapore, 2023. Association for Computational Linguistics. doi: 10.18653/v1/2023.findings-emnlp.378. URL[https://aclanthology.org/2023.findings-emnlp.378](https://aclanthology.org/2023.findings-emnlp.378). -
...
In Houda Bouamor, Juan Pino, and Kalika Bali, editors,
*Findings of the Association for Computational Linguistics: EMNLP 2023*, pages 9248–9274, Singapore, 2023. Association for Computational Linguistics. doi: 10.18653/v1/2023.findings-emnlp.620. URL[https://aclanthology.org/2023.findings-emnlp.620](https://aclanthology.org/2023.findings-emnlp.620). -
Team et al. [2024]
...
*ArXiv preprint*, abs/2403.05530, 2024. URL[https://arxiv.org/abs/2403.05530](https://arxiv.org/abs/2403.05530). -
Trivedi et al. [2022]
Harsh Trivedi, Niranjan Balasubramanian, Tushar Khot, and Ashish Sabharwal.
MuSiQue: Multihop questions via single-hop question composition.
*Transactions of the Association for Computational Linguistics*, 10:539–554, 2022. doi: 10.1162/tacl_a_00475. URL[https://aclanthology.org/2022.tacl-1.31](https://aclanthology.org/2022.tacl-1.31). -
Trivedi et al. [2023]
Harsh Trivedi, Niranjan Balasubramanian, Tushar Khot, and Ashish Sabharwal.
...
*ArXiv preprint*, abs/2212.03533, 2022. URL[https://arxiv.org/abs/2212.03533](https://arxiv.org/abs/2212.03533). -
Wang et al. [2024]
Liang Wang, Nan Yang, Xiaolong Huang, Linjun Yang, Rangan Majumder, and Furu Wei.
Improving text embeddings with large language models.
*ArXiv preprint*, abs/2401.00368, 2024. URL[https://arxiv.org/abs/2401.00368](https://arxiv.org/abs/2401.00368). -
Wei et al. [2022]
...
*ArXiv preprint*, abs/2412.15115, 2024. URL[https://arxiv.org/abs/2412.15115](https://arxiv.org/abs/2412.15115). -
Yang et al. [2025]
...
*Proceedings of the 2018 Conference on Empirical Methods in Natural Language Processing*, pages 2369–2380, Brussels, Belgium, 2018. Association for Computational Linguistics. doi: 10.18653/v1/D18-1259. URL[https://aclanthology.org/D18-1259](https://aclanthology.org/D18-1259). -
Yao et al. [2023]
...
*ArXiv preprint*, abs/2411.19443, 2024. URL[https://arxiv.org/abs/2411.19443](https://arxiv.org/abs/2411.19443). -
Yue et al. [2024]
...
*ArXiv preprint*, abs/2410.04343, 2024. URL[https://arxiv.org/abs/2410.04343](https://arxiv.org/abs/2410.04343). -
Zelikman et al. [2022]
...
we sample up to retrieval chains,
with the maximum length randomly selected from the interval .
The sampling temperature is set to for sub-query generation and for sub-answer generation.
Chain generation is terminated if the sub-answer matches the correct answer
or if the average conditional log-likelihood of the correct answer exceeds .
For each sub-query,
we utilize the E5-large retriever 111[https://huggingface.co/intfloat/e5-large-v2](https://huggingface.co/intfloat/e5-large-v2)
to retrieve the top- most relevant documents
from the KILT version of the Wikipedia corpus [[25](https://arxiv.org/html/2501.14342v3#bib.bib25)].
This corpus comprises million passages.
...
Multi-Hop QA Training Hyperparameters
The training set is the union of the 2WikiMultihopQA, HotpotQA, and MuSiQue datasets,
comprising a total of k samples as shown in Table [6](https://arxiv.org/html/2501.14342v3#A1.T6).
The Bamboogle dataset,
consisting of only questions,
is reserved for evaluation only.
Additional hyperparameters are detailed in Table [5](https://arxiv.org/html/2501.14342v3#A1.T5).
To balance the three loss terms in Section [3.2](https://arxiv.org/html/2501.14342v3#S3.SS2),
we set a sample ratio of for both the sub-query and sub-answer generation tasks;
this ratio is also applied to the KILT training.

KILT Training Hyperparameters We utilize the official training set of the KILT benchmark, omitting the ELI5 and WoW datasets due to the lack of reliable evaluation metrics. To balance the task distribution, we only select k samples for large datasets like T-REx and Zero-Shot RE. In accordance with the benchmark’s guidelines, we also add k samples from the BLINK dataset for entity linking.

Rather than using off-the-shelf retrievers,
we fine-tune an E5-Mistral retriever following [Wang et al.](https://arxiv.org/html/2501.14342v3#bib.bib35),
and a RankLLaMA re-ranker following [Ma et al.](https://arxiv.org/html/2501.14342v3#bib.bib24).
...
Retrieval and re-ranking scores are presented in Table [8](https://arxiv.org/html/2501.14342v3#A2.T8).

All training jobs are conducted using A100 GPUs. The multi-hop QA task requires less than hours of training, whereas the KILT training takes approximately hours. When submitting to the KILT leaderboard, we select the optimal decoding strategy for each task based on validation set performance.

Decoding Strategies In the context of best-of- sampling, the temperature is set to for sub-query generation. For sub-answer generation and final answer prediction, the temperature is always set to across all decoding strategies. Regarding tree search, we set the expansion size to and the number of rollouts to . Given that tree search incurs a significantly higher token consumption compared to other decoding strategies, we limit the rollouts to a maximum of steps for each expansion. To avoid the model from generating repetitive sub-queries endlessly, any generated sub-query identical to previous ones is discarded.

Evaluation
For multi-hop QA tasks,
we evaluate the performance using the exact match (EM) and F1 scores [[18](https://arxiv.org/html/2501.14342v3#bib.bib18)].
For Self-RAG-7B,
we reproduce the results utilizing the FlashRAG [[16](https://arxiv.org/html/2501.14342v3#bib.bib16)] toolkit
...
*validation set*of the KILT benchmark. For re-ranking, we use the top- candidates from the fine-tuned retriever as input.
...
Different Decoding Strategies on the KILT Benchmark
In Table [7](https://arxiv.org/html/2501.14342v3#A2.T7),
...
However,
as illustrated in Figure [6](https://arxiv.org/html/2501.14342v3#A2.F6),
...
*Llama-3.1-8B-Instruct*. No fine-tuning is performed on the model weights.

Scaling Test-Time Compute without Model Fine-Tuning
In Figure [7](https://arxiv.org/html/2501.14342v3#A2.F7),
...
The scaling curves are similar to those observed in Figure [3](https://arxiv.org/html/2501.14342v3#S4.F3),
...
Figure [8](https://arxiv.org/html/2501.14342v3#A2.F8) illustrates the lack of a consistent conclusion
...
As a result,
we stick to a temperature of for both rejection sampling and test-time decoding for simplicity.

| 2WikiQA | HotpotQA | Bamboogle | MuSiQue | |||||
|---|---|---|---|---|---|---|---|---|
| EM | F1 | EM | F1 | EM | F1 | EM | F1 | |
| Fine-tuned Qwen3-4B w/ E5 | 49.3 | 55.3 | 45.0 | 57.9 | 32.8 | 43.1 | 13.4 | 23.8 |
| CoRAG-Qwen3-4B (L=6, greedy) | 69.3 | 74.1 | 51.6 | 64.2 | 49.6 | 62.5 | 24.0 | 34.5 |
| Fine-tuned Qwen3-8B w/ E5 | 52.1 | 57.9 | 47.1 | 60.0 | 33.6 | 47.6 | 15.3 | 26.3 |
| CoRAG-Qwen3-8B (L=6, greedy) | 70.0 | 74.8 | 52.8 | 66.0 | 49.6 | 63.7 | 25.2 | 35.9 |

Extension to Other Model Families
To demonstrate that our CoRAG framework is agnostic to model families and not limited to Llama-based architectures,
we conduct experiments using Qwen3-4B and Qwen3-8B [[38](https://arxiv.org/html/2501.14342v3#bib.bib38)] models following the same training procedure.
As shown in Table [9](https://arxiv.org/html/2501.14342v3#A2.T9),
CoRAG consistently outperforms the baseline fine-tuned models across all datasets and model sizes,
with improvements of over EM points on average.
...
Case Analysis
Table [11](https://arxiv.org/html/2501.14342v3#A4.T11) presents several model predictions on the validation set of the HotpotQA dataset.
...
with corresponding values detailed in Table [10](https://arxiv.org/html/2501.14342v3#A4.T10).
...
-
Justification: We discuss the limitations of our work in Section

[7](https://arxiv.org/html/2501.14342v3#S7). -
Guidelines:
...
-
Justification: Implementation details are provided in Section

[A](https://arxiv.org/html/2501.14342v3#A1). -
Guidelines:
...
-
Justification: We include implementation details in the paper and will release the code and data after publication.
...
-
Justification: We report confidence intervals in Section

[C](https://arxiv.org/html/2501.14342v3#A3). -
Guidelines:
...
-
Justification: We provide details on compute resources in Section
...
-
Justification: Please see Section
...
-
Justification: No safeguards are needed for our work as it does not involve high-risk data or models.
...
[paperswithcode.com/datasets](https://arxiv.org/paperswithcode.com/datasets)has curated licenses for some datasets. Their licensing guide can help determine the license of a dataset. -
•
...
[https://neurips.cc/Conferences/2025/LLM](https://neurips.cc/Conferences/2025/LLM)) for what should or should not be described.
