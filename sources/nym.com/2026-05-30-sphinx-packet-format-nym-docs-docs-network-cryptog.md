...
title: Sphinx Packet Format | Nym Docs
fetched_at: 2026-05-30T15:56:32
content_hash: sha1:8f8ec2a6d535c4e5903371d89613a4138a9bc6a3
...
Nym uses the [ sphinx-packet (opens in a new tab)](https://github.com/nymtech/sphinx) crate for core Sphinx operations. This crate handles packet construction, header encryption, layer processing, and the mathematical operations for key blinding.

## References

[Sphinx paper (opens in a new tab)](https://cypherpunks.ca/~iang/pubs/Sphinx_Oakland09.pdf): Original specification and security proofs[Elle Mouton's Sphinx explainer (opens in a new tab)](https://ellemouton.com/posts/sphinx/): Detailed walkthrough of packet construction[Nym Whitepaper §4 (opens in a new tab)](https://nym.com/nym-whitepaper.pdf): Sphinx in the context of Nym
